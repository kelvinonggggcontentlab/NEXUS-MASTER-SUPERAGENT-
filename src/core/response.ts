...
export class NexusResponseEngine {
  final(execution: AgentExecution): string {
    ...
    if (execution.cancelledAt) return `${prefix}Stopped. I completed ${completed} of ${execution.tasks.length} actions before cancellation. No further action was taken.`;
